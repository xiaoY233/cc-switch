...
pub fn build_helper_install_args_with_source(
    ...
    let command = format!(
        concat!(
            ...
            "printf '%s\\n' \"$status_json\" | grep -q '\"tools\"' && return 0; ",
            "echo 'cc-switch-remote helper is missing required capabilities; install a helper build that includes providers, openclaw, mcp, prompts, skills, sessions, hermes-memory, import-export, and tools' >&2; ",
            "return 64; ",
            "}}; ",
